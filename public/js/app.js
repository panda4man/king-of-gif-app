...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/components/App.vue":
...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/components/Landing.vue":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__socket_manager__ = __webpack_require__("./resources/assets/js/socket-manager.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_giphy_service__ = __webpack_require__("./resources/assets/js/services/giphy-service.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	created: function created() {
		...
		this.socketManager = new __WEBPACK_IMPORTED_MODULE_0__socket_manager__["a" /* default */]();

		/* Successfully joined the room */
		this.socketManager.socket.on('room-joined', function () {
			_this.$router.push({ name: 'lobby', params: { roomCode: _this.forms.join.roomCode } });
		});

		/* Successfully created the new game */
		this.socketManager.socket.on('game-created', function (roomCode) {
			_this.$router.push({ name: 'lobby', params: { roomCode: roomCode } });
		});

		/* Joining room does not exist */
		this.socketManager.socket.on('room-404', function () {
			__WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()('Uh oh!', 'Could not find a room for ' + _this.forms.join.roomCode);
		});

		/* Can't join a room w/o a host */
		this.socketManager.socket.on('room-no-host', function () {
			__WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()('Uh oh', 'This room does not have a host!');
		});

		/* Can't join a rull room */
		this.socketManager.socket.on('room-full', function () {
			__WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()('Uh oh', 'This room is full. Try another fool.');
		});
	},
	...
	methods: {
		...
		joinRoomValidate: function joinRoomValidate() {
			var _this2 = this;
		...
		getRandomGif: function getRandomGif() {
			var _this3 = this;

			__WEBPACK_IMPORTED_MODULE_2__services_giphy_service__["a" /* default */].random('', 'pg').then(function (res) {
				var data = res.data.data;
				_this3.randomGif = data.url;
			}).catch(function (res) {
				if (res.response) {}
			});
		}
...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/components/Lobby.vue":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	created: function created() {
		...
		this.socketManager.socket.on('lobby-joined-confirmed', function (player) {
			_this.players.push(player);
		});

		/* A new player joined the lobby */
		this.socketManager.socket.on('player-joined', function (player) {
			_this.players.push(player);
		});

		/* A player left the lobby */
		this.socketManager.socket.on('player-left', function (player) {
		...
		this.socketManager.socket.on('host-left', function () {
			__WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()('Host Left', 'Looks like the host abandoned you...', 'error');
			_this.$router.replace({ name: 'landing' });
		});
	},

	computed: {
		gamePlayers: function gamePlayers() {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-5ee972b0\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/components/Landing.vue":
/***/ (function(module, exports, __webpack_require__) {
            ...
            _c("div", { staticClass: "columns" }, [
              _c("div", { staticClass: "column" }, [
                _c("div", { staticClass: "has-text-centered" }, [
                  _vm.randomGif
                    ? _c("img", { attrs: { src: _vm.randomGif } })
                    : _vm._e()
                ])
              ]),
              _vm._v(" "),
                ...
                _c(
                  ...
                  [
                    _c("div", { staticClass: "field" }, [
                        ...
                        _c("input", {
                          directives: [
                            ...
                            },
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.forms.join.roomCode,
                              expression: "forms.join.roomCode"
                            }
                          ],
                          staticClass: "input",
                          class: { "is-danger": _vm.errors.has("roomCode") },
                          attrs: {
                            "data-vv-as": "room code",
                            name: "roomCode",
                            placeholder: "Room Code"
                          },
                          domProps: { value: _vm.forms.join.roomCode },
                          on: {
                      ...
                      _vm._v(" "),
                      _vm.errors.has("roomCode")
                        ? _c(
                            "div",
                            { staticClass: "helper is-danger" },
                            _vm._l(_vm.errors.collect("roomCode"), function(
                              error
                            ) {
                    ...
                    _c("div", { staticClass: "field" }, [
                        ...
                        _c("input", {
                          directives: [
                            ...
                            },
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.forms.join.username,
                              expression: "forms.join.username"
                            }
                          ],
                          staticClass: "input",
                          class: { "is-danger": _vm.errors.has("username") },
                          attrs: { name: "username", placeholder: "Username" },
                          domProps: { value: _vm.forms.join.username },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                      ...
                      _vm.errors.has("username")
                        ? _c(
                            "div",
                            { staticClass: "helper is-danger" },
                            _vm._l(_vm.errors.collect("username"), function(
                              error
                            ) {
                              return _c("div", [_vm._v(_vm._s(error))])
                            })
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "field has-text-centered" }, [
      _c(
        "button",
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-65d6eda2\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/components/Lobby.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-8142f38c\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/components/App.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__socket_manager__ = __webpack_require__("./resources/assets/js/socket-manager.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__route_listener__ = __webpack_require__("./resources/assets/js/route-listener.js");
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$http.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest';
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    template: '<App/>',
    components: { App: __WEBPACK_IMPORTED_MODULE_2__components_App_vue___default.a },
    created: function created() {
        var socketManager = new __WEBPACK_IMPORTED_MODULE_6__socket_manager__["a" /* default */]();
        socketManager.connect(__WEBPACK_IMPORTED_MODULE_5_socket_io_client___default.a);
    }
});
...
if (token) {
    __WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$http.defaults.headers.common['X-CSRF-TOKEN'] = token.content;
} else {
...
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/components/App.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-8142f38c\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/components/App.vue")
/* template functional */
...
/***/ "./resources/assets/js/components/Landing.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/components/Landing.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-5ee972b0\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/components/Landing.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = null
...
/***/ "./resources/assets/js/components/Lobby.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/components/Lobby.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-65d6eda2\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/components/Lobby.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = null
...
/***/ "./resources/assets/js/route-listener.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__router__ = __webpack_require__("./resources/assets/js/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__socket_manager__ = __webpack_require__("./resources/assets/js/socket-manager.js");



__WEBPACK_IMPORTED_MODULE_0__router__["a" /* default */].beforeEach(function (to, from, next) {
    var manager = new __WEBPACK_IMPORTED_MODULE_1__socket_manager__["a" /* default */]();
    console.log(to, from);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Landing_vue__ = __webpack_require__("./resources/assets/js/components/Landing.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Landing_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_Landing_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Lobby_vue__ = __webpack_require__("./resources/assets/js/components/Lobby.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Lobby_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_Lobby_vue__);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    routes: [{
        path: '/',
        name: 'landing',
        component: __WEBPACK_IMPORTED_MODULE_2__components_Landing_vue___default.a
    }, {
        path: '/lobby/:roomCode',
        name: 'lobby',
        component: __WEBPACK_IMPORTED_MODULE_3__components_Lobby_vue___default.a
    }]
}));

/***/ }),

/***/ "./resources/assets/js/services/giphy-service.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var GiphyService = function () {
    ...
    _createClass(GiphyService, null, [{
        key: 'random',
        value: function random() {
            var tag = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
            var rating = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'g';

            var url = '/giphy/random';

            return __WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$http.get(url, {
                params: {
                    tag: tag,
                    rating: rating
                }
...
/* harmony default export */ __webpack_exports__["a"] = (GiphyService);

/***/ }),

/***/ "./resources/assets/js/socket-manager.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["a"] = (SocketManager);
